...
export class AuthEmailService {
  ...
  /**
   * Hashes a raw token with SHA-256 for consistent database persistence and lookup.
   */
  ...
  async sendVerificationEmail(user: AuthenticatedUser): Promise<void> {
    ...
    await this.emailService.sendEmail(
      ...
      `<h2>Welcome to Word Tabernacle BC</h2><p>Hello ${user.fullName},</p><p><a href="${verificationUrl}">Verify Email</a></p>`,
    );
  }
